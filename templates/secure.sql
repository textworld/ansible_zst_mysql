alter user root@'localhost' identified by '{{ mysql_root_password | default("i_am_a_random_password") }}' ;
create user root@'127.0.0.1' identified by '{{ mysql_root_password | default("i_am_a_random_password") }}';
